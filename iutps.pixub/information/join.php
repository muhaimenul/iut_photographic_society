...
<body>
	...
	<div id="content">
        <div class="content_item">
			...
			<h4>To join us you need to E-mail our <a href="#">Treasurer or Secretary</a> , or come along to one of our meetings and speak with us in person. We meet every Wednesday evening starting at 8:00 pm at the 
				 <a href="https://www.facebook.com/IUTPS/">IUT</a> in Hemel Hempstead, Hertfordshire.
				 Look at the events list at the left hand side of
				 this page to see when the next one is due. For
				 help with finding us Click Here.
				 To allow you to get a feel for HHPS and whether
				 or not it's right for you, why not come along to a
				 few Monday meetings and see for yourself? All
				 you'll need to pay is the small door levy; then
				 pay the annual membership fee later if you
				 decide to join us.
				 How much does it cost? <a href="member_list.php">Click Here</a> to see our
				 current membership rates.
			</h4>
			
			
			<!--<img width="680" height="500" src="../images/uc.gif" alt="&quot;IUT&quot;" style="margin-left:'20px';" />-->
