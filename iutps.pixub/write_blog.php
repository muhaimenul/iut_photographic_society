...
<body>
	...
	<div id="content">
        <div class="content_item">
			...
			<p><span>Your Name</span><input class="contact" type="text" name="b_name" value="" required /></p>
			<p><span>Article Title</span><input class="contact" type="text" name="b_title" value="" required /></p>
			<p><span>Body</span><textarea class="contact textarea" rows="15 cols="60" name="b_body"></textarea></p>
